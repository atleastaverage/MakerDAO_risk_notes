...
Rune: That's becoming more popular in the DeFi space. The shift from using eth as a collatoralization method in order to acquire DAI, but there are lending markets looking for DAI. We're actually feeding into compound, nuo, uniswap. One of the major driver for DAI inventory is people lending from other platforms.
